...
class YouTu
{
    ...
    public static function detectface($image_path, $isbigface) 
    {
        ...
        $postUrl = Config('youtu.end_point') . 'youtu/api/detectface';
    ...
    public static function faceshape($image_path, $isbigface) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/faceshape';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
   ...
   /**
    ...
    public static function facecompare($image_path_a, $image_path_b) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/facecompare';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function faceverify($image_path,$person_id) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/faceverify';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function faceidentify($image_path,$group_id) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/faceidentify';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
	...
	* @return 返回的结果，JSON字符串，字段参见API文档
    ...
    public static function newperson($image_path, $person_id, array $group_ids, $person_name='', $person_tag='') 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/newperson';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    * @return 返回的结果，JSON字符串，字段参见API文档
    ...
    public static function delperson($person_id) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/delperson';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function addface($person_id,array $image_path_arr, $facetag='') 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/addface';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function delface($person_id,array $face_id_arr)
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/delface';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
	...
	* @return 返回的结果，JSON字符串，字段参见API文档
    ...
    public static function setinfo($person_name,$person_id, $person_tag) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/setinfo';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
	...
	* @return 返回的结果，JSON字符串，字段参见API文档
    ...
    public static function getinfo($person_id) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/getinfo';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function getgroupids() 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/getgroupids';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function getpersonids($group_id)
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/getpersonids';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function getfaceids($person_id) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/getfaceids';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function getfaceinfo($face_id) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/api/getfaceinfo';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function fuzzydetect($image_path) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/imageapi/fuzzydetect';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function fooddetect($image_path) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/imageapi/fooddetect';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function imagetag($image_path) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/imageapi/imagetag';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function imageporn($image_path) 
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/imageapi/imageporn';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
     ...
     * @return 返回的结果，JSON字符串，字段参见API文档
     */
    public static function idcardimgocr($image_data, $card_type = 0, $seq = '', $border_check_flag=false) 
    {
        $expired = time() + self::EXPIRED_SECONDS;
        ...
        $post_data = array(
            ...
            'seq' => $seq,
            'card_type' => $card_type,
            'border_check_flag'=>$border_check_flag
        );
    ...
    public static function namecardocrurl($url, $retimage = 1, $seq = '')
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/ocrapi/namecardocr';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function livegetfour($seq = '')
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/openliveapi/livegetfour';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function livedetectfour($validate_data,$video_path,$card_path,$compare_card=false,$seq = '')
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/openliveapi/livedetectfour';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function idcardlivedetectfour($idcard_number,$idcard_name,$validate_data,$video_path,$seq = '')
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/openliveapi/idcardlivedetectfour';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function idcardfacecompare($idcard_number,$idcard_name,$image_path,$seq = '')
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/openliveapi/idcardfacecompare';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function validateidcard($idcard_number,$idcard_name,$seq = '')
    {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/openliveapi/validateidcard';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function generalocr($image_path, $seq='') {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/ocrapi/generalocr';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function driverlicenseocr($image_path, $card_type, $seq='') {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/ocrapi/driverlicenseocr';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
    ...
    public static function bcocr($image_path, $seq='') {
        ...
        $expired = time() + self::EXPIRED_SECONDS;
        $postUrl = Config('youtu.end_point') . 'youtu/ocrapi/bcocr';
        $sign = Auth::appSign($expired, Config('youtu.user_id'));
